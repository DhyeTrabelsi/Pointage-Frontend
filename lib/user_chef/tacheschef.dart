                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            'Pointage ' +
                                                                                (_itemspointages.indexOf(itempointage) + 1).toString(),
                                                                            style:
                                                                                TextStyle(
                                                                              fontFamily: 'roboto',
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            'Entry time: ' +
                                                                                datapointageschef[_itemspointages.indexOf(itempointage)]["entre"],
                                                                            style:
                                                                                TextStyle(
                                                                              fontSize: 15.0,
                                                                            ),
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            'Exit time: ' +
                                                                                datapointageschef[_itemspointages.indexOf(itempointage)]["sortie"],
                                                                            style:
                                                                                TextStyle(
                                                                              fontSize: 15.0,
                                                                            ),
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            'Check-in time : ' +
                                                                                datapointageschef[_itemspointages.indexOf(itempointage)]["date"],
                                                                            style:
                                                                                TextStyle(
                                                                              fontSize: 15.0,
                                                                            ),
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            'Dealy time: ' +
                                                                                datapointageschef[_itemspointages.indexOf(itempointage)]["retard"],
                                                                            style:
                                                                                TextStyle(
                                                                              fontSize: 15.0,
                                                                            ),
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            'Absence: ' +
                                                                                datapointageschef[_itemspointages.indexOf(itempointage)]["absance"],
                                                                            style:
                                                                                TextStyle(
                                                                              fontSize: 15.0,
                                                                            ),
